...
x = (raw_x/ scale_factor) - x_offset;
y = (raw_y / scale_factor) - y_offset;
z = (raw_z / scale_factor) - z_offset;
}

void mpu6050::getAngles(){
    pitch = atan2(y, sqrt(x*x+z*z)) * 180 / PI - baseline_pitch;
    roll = atan2(-x, z) * 180 / PI - baseline_roll;
}
